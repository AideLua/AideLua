...
permissionInformation={
  {
    ...
    summary=gLLO("存储项目、编辑文件、调试项目等","Store projects, edit files, debug projects, etc.");
  ...
  },
 {
    ...
    summary=gLLO("在后台提示任务进度 (需进入“设置”给予)","Prompt task progress in the background. (Need to enter \"Settings\")");
    permissions={"com.huawei.permission.POPUP_BACKGROUND_WINDOW"};
  },
   {
    icon=R.drawable.ic_android,
    title=gLLO("安装应用","Install application");
    summary=gLLO("在文件浏览器、二次打包内快捷安装应用 (需进入“设置”给予)","Quickly install applications in the file browser and secondary packaging. (Need to enter \"Settings\")");
