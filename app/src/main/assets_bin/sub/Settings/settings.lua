return {
  ...
  {--工程路径
...
]]
    {
      ...
      summary=formatResStr(R.string.jesse205_nowVersion_full,{BuildConfig.VERSION_NAME,BuildConfig.VERSION_CODE});
      key="about";
      newPage=true;
    };
  };
