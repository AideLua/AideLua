...
import "com.jesse205.util.ScreenUtil"
...
PermissionUtil.askForRequestPermissions({
    {
        ...
        todo = getLocalLangObj("获取文件列表，读取文件和保存文件",
            "Get file list, read file and save file"),
...
---@param device string 新设备类型
---@param oldDevice string 旧设备类型，初始为 `"phone"`
